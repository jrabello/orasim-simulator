...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = (function () {
	    ...
	    function Main() {
	        ...
	        this.sqlInternalData = new sql_data_container_1.SqlDataContainer();
	        //this.someDelay()    
	    }
	    Main.prototype.getSqlDataContainer = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sql_console_message_1 = __webpack_require__(8);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SqlButtons = (function () {
	    ...
	    SqlButtons.prototype.getButtonRollback = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SqlButtonSelect = (function () {
	    ...
	    SqlButtonSelect.prototype.handleSelect = function () {
	        ...
	        sharedPool.addHash(hash);
	        var sqlDataContainer = Orasim.getSqlDataContainer();
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var animation_connect_1 = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var animation_insert_1 = __webpack_require__(18);
	var sql_id_1 = __webpack_require__(14);
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        ...
	                        sqlDataContainer.add(query, hash);
	                        return [4 /*yield*/, new animation_insert_1.AnimationInsert(hash, hashFound).start()];
	                    case 1:
	                        _a.sent();
	                        return [2 /*return*/];
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimationInsert = (function (_super) {
	    ...
	    function AnimationInsert(hash, isHashFound) {
	        var _this = _super.call(this) || this;
	        _this.hash = hash;
	        _this.animationTime = _super.prototype.getDelay.call(_this) * 5;
	        _this.isHashFound = isHashFound;
	        return _this;
	    }
	    /**
	     * start
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SqlButtonRollback = (function () {
	    ...
	    return SqlButtonRollback;
	}());
	exports.SqlButtonRollback = SqlButtonRollback;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RedoLogFiles = (function () {
	    ...
	    //     }
	    // }
	    RedoLogFiles.prototype.enableGroup = function (grp) {
	        return __awaiter(this, void 0, void 0, function () {
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        ...
	                        return [4 /*yield*/, new delay_1.Delay(6000).sleep()];
	                    case 1:
	                        _a.sent();
	                        return [2 /*return*/];
	                }
	    ...
	    //vermelho
	    RedoLogFiles.prototype.blockGroup = function (grp) {
	        return __awaiter(this, void 0, void 0, function () {
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	    ...
	    //cinza
	    RedoLogFiles.prototype.disableGroup = function (grp) {
	        return __awaiter(this, void 0, void 0, function () {
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	        ...
	        return __awaiter(this, void 0, void 0, function () {
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    ...
	                    case 2:
	                        _a.sent();
	                        return [4 /*yield*/, this.enableGroup(this.selectorIndex)]; //verde/cinza
	                    case 3:
	                        _a.sent(); //verde/cinza
	                        return [2 /*return*/];
	                }
	    ...
	    RedoLogFiles.prototype.storeData = function (blocks) {
	        return __awaiter(this, void 0, void 0, function () {
	            var sizeBlocks, selectorPlusOne;
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        ...
	                        Orasim.getSqlConsole().addMsg(new sql_console_msg_info_1.SqlConsoleMsgInfo('< ARCH > Iniciando geração de archive'));
	                        return [4 /*yield*/, new delay_1.Delay(3000).sleep()];
	                    case 1:
	                        _a.sent();
	                        return [4 /*yield*/, this.blockGroup(this.selectorIndex)]; //red/cinza
	                    case 2:
	                        _a.sent(); //red/cinza
	                    ...
	                    case 10:
	                        ...
	                        return [4 /*yield*/, this.enableGroup(this.selectorIndex)]; //cinza/verde
	                    case 11:
	                        _a.sent(); //cinza/verde
	...
	exports.RedoLogFiles = RedoLogFiles;
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    ...
	                    case 3:
	                        //uma vez no log-writer precisamos envia-los ao redo-log-files
	                        _a.sent();
	                        redoLogFiles = Orasim.getOracleDatabase().getRedoLogFiles();
	                        return [4 /*yield*/, redoLogFiles.showCurrentLogGroup()];
	                    case 4:
	                        _a.sent();
	                        return [4 /*yield*/, redoLogFiles.storeData(blocks)];
	                    case 5:
	                        _a.sent();
	                        return [2 /*return*/];
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SqlDataContainer = (function () {
	    ...
	    SqlDataContainer.prototype.add = function (queryName, hash) {
	        if (this.sqlQueryDataMap.has(hash.getHash()))
	            return;
	        this.sqlQueryDataMap.insert([hash.getHash(), new sql_query_data_1.SqlQueryData(queryName, hash)]);
	    };
	    return SqlDataContainer;
	}());
	exports.SqlDataContainer = SqlDataContainer;
...
/***/ function(module, exports) {
	...
	exports.SqlQueryData = SqlQueryData;
